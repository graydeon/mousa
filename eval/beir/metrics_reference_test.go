...
// Each case corresponds to a defect the 2026-09-15 adversarial review reproduced
// against the previous binary implementation; they assert the correct behavior.
...
// zero} must score 1, not 0.5 (review finding R2).
...
// scored both orders 1.0 (review finding R2).
